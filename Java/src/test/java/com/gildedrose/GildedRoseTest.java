...
class GildedRoseTest {
    ...
    void decrementQualityForRegularItemsAndZeroSellIn() {
        ...
        assertEquals(itemName, app.getItems().get(0).name);
        assertEquals(0, app.getItems().get(0).sellIn);
        assertEquals(3, app.getItems().get(0).quality);
        ...
        app.updateQuality();
        assertEquals(itemName, app.getItems().get(0).name);
        assertEquals(-2, app.getItems().get(0).sellIn);
        assertEquals(0, app.getItems().get(0).quality);


        app.updateQuality();
        assertEquals(itemName, app.getItems().get(0).name);
        assertEquals(-3, app.getItems().get(0).sellIn);
        assertEquals(0, app.getItems().get(0).quality);
    }
    ...
    void decrementQualityForRegularItemsAndPositiveSellIn() {
        ...
        assertEquals(itemName, app.getItems().get(0).name);
        assertEquals(3, app.getItems().get(0).sellIn);
        assertEquals(2, app.getItems().get(0).quality);
    ...
    void agedBrieWithQualityOverThresholdAndPositiveSellIn() {
        ...
        assertEquals(agedBrie, app.getItems().get(0).name);
        assertEquals(1, app.getItems().get(0).sellIn);
    ...
    void agedBrieWithQualityBellowThresholdAndZeroSellInIncrementQualityAtTheBeginning() {
        ...
        assertEquals(agedBrie, app.getItems().get(0).name);
        assertEquals(0, app.getItems().get(0).sellIn);
        assertEquals(49, app.getItems().get(0).quality);
    ...
    void agedBrieWithQualityBellowThresholdAndZeroSellInIncrementQualityTwice() {
        ...
        assertEquals(agedBrie, app.getItems().get(0).name);
        assertEquals(0, app.getItems().get(0).sellIn);
        assertEquals(48, app.getItems().get(0).quality);
    ...
    void backstagePositiveSellInIncrementQualityBecauseSellInLessThanThresholdAndQualityBellowThreshold() {
        ...
        assertEquals(backstage, app.getItems().get(0).name);
        assertEquals(10, app.getItems().get(0).sellIn);
        assertEquals(49, app.getItems().get(0).quality);
    ...
    void backstagePositiveSellInIncrementX3QualityBecauseSellInLessThanThresholdAndQualityBellowThreshold() {
        ...
        assertEquals(backstage, app.getItems().get(0).name);
        assertEquals(5, app.getItems().get(0).sellIn);
        assertEquals(47, app.getItems().get(0).quality);

        app.updateQuality();
        assertEquals(backstage, app.getItems().get(0).name);
        assertEquals(4, app.getItems().get(0).sellIn);
        assertEquals(50, app.getItems().get(0).quality);
    }
    ...
    void ragnarosWithNegativeInitialSellInMaintainQuality() {
        ...
        assertEquals(ragnaros, app.getItems().get(0).name);
        assertEquals(-1, app.getItems().get(0).sellIn);
        assertEquals(50, app.getItems().get(0).quality);
